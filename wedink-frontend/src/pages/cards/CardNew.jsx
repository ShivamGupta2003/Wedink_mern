...
//       await api.post(`/listings/${id}/Mcard`, formData)
//       showSuccess('Marriage card added!')
//       navigate(`/listings/${id}/Mcard`)
//     } catch (err) {
//       showError(err.response?.data?.message || 'Failed to create card')
...
//         .form-control:focus, .form-select:focus { box-shadow: 0 0 0 .25rem rgba(40,167,69,.25); border-color: #28a745; transition: all .3s ease; }
...
//         <h2 className="text-center mb-4 animate__animated animate__fadeInDown">Submit a New Card Listing</h2>
...
//                     <input name="marriageCard[cardName]" className="form-control border-success" placeholder="Enter Card Name" type="text" required onFocus={handleFocus} onBlur={handleBlur} />
//                   </div>
...
//                   <textarea name="marriageCard[description]" className="form-control border-success" placeholder="Enter Card Description" rows="3" required onFocus={handleFocus} onBlur={handleBlur}></textarea>
//                   <div className="invalid-feedback">Please provide a description of the card.</div>
//                 </div>
...
//                     <input name="image" className="form-control border-success" type="file" required />
//                   </div>
...
//                   <div className="input-group">
//                     <span className="input-group-text bg-success text-white">₹</span>
//                     <input name="marriageCard[price]" className="form-control border-success" placeholder="Enter Card Price" type="number" min="0" step="0.01" required onFocus={handleFocus} onBlur={handleBlur} />
//                   </div>
...
//                   <div className="input-group">
//                     <span className="input-group-text bg-success text-white">🎨</span>
//                     <select name="marriageCard[theme]" className="form-select border-success" required defaultValue="">
...
//                     </select>
//                   </div>
//                   <div className="invalid-feedback">Please select a valid theme.</div>
//                 </div>
...
//                   <div className="input-group">
//                     <span className="input-group-text bg-success text-white">📄</span>
//                     <select name="marriageCard[material]" className="form-select border-success" required defaultValue="">
...
//                     </select>
//                   </div>
//                   <div className="invalid-feedback">Please select the material.</div>
//                 </div>
...
//                   <div className="input-group">
//                     <span className="input-group-text bg-success text-white">📏</span>
//                     <input name="marriageCard[size]" className="form-control border-success" placeholder="Enter Card Size (e.g., 5x7 inches)" type="text" required onFocus={handleFocus} onBlur={handleBlur} />
//                   </div>
//                   <div className="invalid-feedback">Please enter the size of the card.</div>
//                 </div>

//                 <div className="text-center animate__animated animate__fadeInUp" style={{ animationDelay: '0.9s' }}>
//                   <button type="submit" className="btn btn-success btn-lg w-100 shadow" disabled={loading}>
//                     {loading
//                       ? <><span className="spinner-border spinner-border-sm me-2" role="status"></span>Submitting...</>
//                       : <><i className="bi bi-plus-circle me-2"></i>Submit Card</>}
//                   </button>
//                 </div>
//               </form>
//             </div>
      ...
      <div className="ce-root">
        ...
        <section className="ce-hero">
          ...
          <div className="ce-hero-inner">
            ...
            <div className="ce-hero-title">Submit a New Card Listing</div>
          </div>
        </section>
        ...
        <div className="ce-main">
          ...
          <div className="ce-form-card">
            ...
            >
              ...
              {/* Description */}
              <div className="ce-field">
                <label className="ce-label">Card Description</label>
                <textarea
                  ...
                  onBlur={handleBlur}
                />
                <div className="ce-invalid-msg">Please provide a description of the card.</div>
              </div>
              ...
              <div className="ce-field">
                ...
                <div className="ce-input-group">
                  ...
                  <input name="image" className="ce-file" type="file" required />
                </div>
              ...
              <div className="ce-field">
                ...
                <div className="ce-invalid-msg">Please select a valid theme.</div>
              </div>
              ...
              <div className="ce-field">
                ...
                <div className="ce-invalid-msg">Please select the material.</div>
              </div>
              ...
              <div className="ce-field">
                ...
                <div className="ce-invalid-msg">Please enter the size of the card.</div>
              </div>

              {/* Submit */}
              <button type="submit" className="ce-btn-gold" disabled={loading}>
                {loading ? (
                  <><div className="ce-spinner-sm" /> Submitting…</>
                ) : (
                  <><i className="fas fa-plus-circle" style={{ fontSize: 13 }} /> Submit Card</>
                )}
              </button>
